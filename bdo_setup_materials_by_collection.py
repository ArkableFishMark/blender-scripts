...
# (Helper functions identical to the Object-Hierarchy version)
...
def get_all_objects_in_collection(collection, objects_set):
    ...
    for sub_col in collection.children:
        get_all_objects_in_collection(sub_col, objects_set)
...
if active_collection:
    ...
    print(f"Collection hierarchy processed: '{active_collection.name}'")
else:
    print("Warning: No active collection found.")
